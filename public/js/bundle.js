...
const SimpleVideoPlayer = __webpack_require__(27);

ReactDOM.render(React.createElement(SimpleVideoPlayer, { muted: true, loop: false, src: 'https://s3-eu-west-1.amazonaws.com/onrewind-test-bucket/big_buck_bunny.mp4' }), document.getElementById('app'));
...
const ToggleButton = __webpack_require__(28);
const ProgressBar = __webpack_require__(29);
	...
	render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(ProgressBar, { duration: this.state.duration, currentTime: this.state.currentTime })
			),
			React.createElement(ToggleButton, { name: 'play-toggle', label: this.state.playing ? "Pause" : "Play", onClick: this.onToggleClick })
		);
	}
}
...
module.exports = props => {
	return React.createElement(
		'button',
		{ name: props.name, className: 'play-toggle', onClick: props.onClick },
		props.label
	);
};
...
module.exports = props => {
	...
	return React.createElement(
		...
		React.createElement('div', { className: 'progress-bar', style: { transform: `scale(${progressRatio}, 1.0)` } })
	);
};
